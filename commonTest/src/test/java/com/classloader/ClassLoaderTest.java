...
//                Class<?> clazz = null;
//                try {
//                    clazz = myLoader.loadClass("com.classloader.ClassLoaderTest");
...
//        ClassLoader myLoader = new MyClassLoader();
//
//        Class<?> clazz = myLoader.loadClass("com.classloader.ClassLoaderTest");
//
//        Object obj = clazz.newInstance();
//
...
//
//        // 获取CallClassLoader
//        Class<?> clz = Class.forName("com.classloader.ClassLoaderTest");
//        System.out.println(clz);    //class com.classloader.ClassLoaderTest
//        System.out.println(clz.getClassLoader());  //sun.misc.Launcher$AppClassLoader@135fbaa4
//        System.out.println(clz.getClass());     //class java.lang.Class
//        System.out.println(clz.getClass().getClassLoader());    //null
//
//    }
